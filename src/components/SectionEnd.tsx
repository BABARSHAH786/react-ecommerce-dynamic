export default function SecEnd() {
  return (
    <div>
      {/* <div>
        <p className=" text-[22px] leading-[28px] font-medium ml-[48px] ">
          Don&apos;t Miss
        </p>
        <img
      ...
      <div className="mt-12 max-ss:ml-[0px]">
        <h3 className="text-[52px] max-ss:text-[23px] leading-[60px] text-center font-medium ml-[48px]">
          FLIGHT ESSENTIALS
        </h3>
        <p className="text-center mt-8 max-ss:w-[310px] max-ss:ml-12">
          Your built-to-last, all-week wears—but with style only Jordan Brand
          can deliver.
        </p>
        <div className="flex justify-center mt-9 ">
          <a href={"/all-product-page"}>
            <button className="w-[110px ] text-white h-[39px] bg-[#111111] rounded-[30px] py-[7px] px-[22px]   ">
              Shop
            </button>{" "}
          </a>
        </div>
      ...
      <div className="max-ss:w-[310px] max-ss:h-[1010px] w-[1344px] h-[592px] ml-12 ">
        <p className="font-medium text-[23px] mt-4 leading-7 ">
          The Essentials
        </p>
